...
class CategorySurveysViewModel(private val repository: CategorySurveysRepository) : ViewModel() {

    fun loadSurveysByCategoty(categoryId: Long): LiveData<List<Survey>> {
//        return runBlocking {
//            Transformations.map(repository.loadSurveysByCategory(categoryId)){list ->
